...
class Collection implements ArrayAccess, Countable, IteratorAggregate, JsonSerializable
{
     ...
     */
    public function sortBy(callable|string|array $callback, int $options = SORT_REGULAR, bool $descending = false): self
    {
        if (is_array($callback)){
            return new static($this->sortByMultipleFields($callback));
        }
        $results = [];
    ...
    /**
     * sort by multiple fields [ ['col1', 'asc'], ['col2', 'desc'] ]
     * @param $comparisons
     * @return array
     */
    protected function sortByMultipleFields($comparisons): array
    {
        $items = $this->items;
